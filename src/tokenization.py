...
def tokenize_en(text, lm):
    """
    Tokenizes English text from a string into a list of strings (tokens) and adds required tokens
    """
    init_token = "<sos>"
    eos_token = "<eos>"
    text_tokens = (
        [init_token] + [tok.lower_ for tok in lm.tokenizer(text)] + [eos_token]
    )
